            ...
            <div className="row">
              <div className="col-lg-12 col-md-12">
                <div className="filter_search_opt">
                  <a href="javascript:void(0);" onclick="openFilterSearch()">Search Property<i className="ml-2 ti-menu" /></a>
                </div>
              </div>
            </div>
            <div className="row">
                    ...
                    <div className="item-shorting-box">
                      ...
                      <div className="item-shorting-box-right">
                        ...
                        <ul className="shorting-list">
                          <li><a href="grid-layout-with-sidebar.html" className="active"><i className="icofont-layout-grid2" /></a></li>
                          <li><a href="list-layout-with-sidebar.html"><i className="icofont-view-list" /></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
