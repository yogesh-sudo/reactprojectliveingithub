...
const Home2 = () => {
    return (
        <>
         <div>
        {/* ============================ Hero Banner  Start================================== */}
        <div className="image-bottom hero-banner" style={{background: '#2540a2 url(assets/img/banner.svg) no-repeat'}} data-overlay={0}>
                  ...
                  <div className="listing-content">
                    ...
                    <div className="listing-footer-wrapper">
                      <div className="listing-locate">
                        <span className="listing-location"><i className="icofont-location-pin" />Quice Market, Canada</span>
                      </div>
        ...
        <section>
          <div className="container">
              ...
              <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="agents-grid">
                  <div className="agents-grid-wrap">
                    ...
                    <div className="fr-grid-deatil">
                      <div className="fr-grid-deatil-flex">
                        <h5 className="fr-can-name"><a href="#/">James N. Green</a></h5>
                        <span className="agent-property">117 Properties</span>
                      </div>
                      <div className="fr-grid-deatil-flex-right">
                        <div className="agent-email"><a href="#/"><i className="icofont-email" /></a></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="fr-grid-footer">
                    <div className="fr-grid-footer-flex">
                      <span className="fr-position"><i className="lni-map-marker" />3599 Huntz Lane</span>
                    </div>
                    <div className="fr-grid-footer-flex-right">
                      <a href="agent-page.html" className="prt-view" tabIndex={0}>View</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="agents-grid">
                  <div className="agents-grid-wrap">
                    ...
                    <div className="fr-grid-deatil">
                      <div className="fr-grid-deatil-flex">
                        <h5 className="fr-can-name"><a href="#/">Charles T. Hines</a></h5>
                        <span className="agent-property">302 Properties</span>
                      </div>
                      <div className="fr-grid-deatil-flex-right">
                        <div className="agent-email"><a href="#/"><i className="icofont-email" /></a></div>
                      </div>
              ...
              <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="agents-grid">
                  <div className="agents-grid-wrap">
                    ...
                    <div className="fr-grid-deatil">
                      <div className="fr-grid-deatil-flex">
                        <h5 className="fr-can-name"><a href="#/">Colin H. Renda</a></h5>
                        <span className="agent-property">302 Properties</span>
                      </div>
                      <div className="fr-grid-deatil-flex-right">
                        <div className="agent-email"><a href="#/"><i className="icofont-email" /></a></div>
            ...
            <div className="row">
              <div className="col-lg-12 col-md-12 col-sm-12 text-center">
                <a href="listings-list-with-sidebar.html" className="btn btn-theme-light-2 rounded">Explore More Agents</a>
              </div>
            </div>
          </div>
        </section>
