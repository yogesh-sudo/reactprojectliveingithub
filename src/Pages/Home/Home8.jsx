...
const Home8 = () => {
    return (
        ...
        <div className="home-slider margin-bottom-0">
          {/* Slide */}
          <div data-background-image="assets/img/banner-1.jpg" className="item">
                  ...
                  <div className="home-slider-container">
                    ...
                    <div className="home-slider-desc">
                      ...
                      <div className="home-slider-title">
                        ...
                        <span><i className="lni-map-marker" /> 778 Country St. Panama City, FL</span>
                      </div>
                      ...
                      <div className="listing-price-with-compare">
                        <h4 className="list-pr theme-cl">$2,580</h4>
                        <div className="lpc-right">
                          <a href="compare-property.html" data-toggle="tooltip" data-placement="top" title="Tooltip on top"><i className="icofont-control-shuffle" /></a>
                          <a href="#/" data-toggle="tooltip" data-placement="top" title="Tooltip on top"><i className="icofont-heart" /></a>
                        </div>
                      </div>
                      <a href="single-property-page-1.html" className="read-more">View Details <i className="fas fa-angle-right"></i></a>
                    </div>
                    {/* Slide Title / End */}
                  </div>
                </div>
          ...
          {/* Slide */}
          <div data-background-image="assets/img/banner-3.jpg" className="item">
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <div className="home-slider-container">
                    ...
                    <div className="home-slider-desc">
                      ...
                      <a href="single-property-page-1.html" className="read-more">View Details <i className="fa fa-angle-right" /></a>
                    </div>
                    {/* Slide Title / End */}
                  </div>
                </div>
          ...
          {/* Slide */}
          <div data-background-image="assets/img/banner-2.jpg" className="item">
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <div className="home-slider-container">
