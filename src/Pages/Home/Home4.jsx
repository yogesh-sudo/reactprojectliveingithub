...
const Home4 = () => {
    return (
        <>
         <div>
        {/* ============================ Hero Banner  Start================================== */}
        <div className="image-cover hero-banner" style={{background: '#2540a2 url(assets/img/banner-6.png) no-repeat'}} data-overlay={0}>
          <div className="container">
            <div className="row">
              <div className="col-lg-8 col-md-11 col-sm-12">
                <p className="lead-i text-light">Amet consectetur adipisicing <span className="badge badge-success">New</span></p>
                <h2>Find Your Place<br />of Dream</h2>
